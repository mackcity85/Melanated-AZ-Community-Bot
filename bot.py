...
def build_application():
    ...
    try:
        ...
        application.add_handler(CallbackQueryHandler(handle_event_admin_callback, pattern=r"^event_ocr_admin_(?:edit(?:_(?:event|date|time|location|price|website))?|approve|deny)_\d+$"), group=-2)
