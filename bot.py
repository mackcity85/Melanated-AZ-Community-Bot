...
async def _raffle_main_chat_repost_checker(context):
    ...
    try:
        ...
        if posted:
            ...
            logger.info("RAFFLE MAIN REPOST COMPLETE | time=%02d:%02d Arizona", RAFFLE_MAIN_REPOST_HOUR, RAFFLE_MAIN_REPOST_MINUTE)
        else:
...
def build_application():
    ...
    if application.job_queue:
        ...
        logger.info(
            "RAFFLE MAIN REPOST SCHEDULER VERIFIED | checker=30s | target=%02d:%02d Arizona | chat=-1002697105809",
            RAFFLE_MAIN_REPOST_HOUR,
            RAFFLE_MAIN_REPOST_MINUTE,
        )
