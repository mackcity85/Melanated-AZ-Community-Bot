...
#
# Handles gameplay for the Game Center.
#
# Compatible with:
...
def replay_keyboard(game_id):
    """
    Return replay + Game Center buttons.
    """
...
def ensure_player(
    ...
    """
    Create or update a Game Center player.
    """
...
def record_game_result(
    ...
    """
    Record game result, XP, coins and statistics.
    """
...
CHALLENGES = {
    ...
    "detective": [
        ("🕵🏾 Case solved!", True),
        ("🔍 You found the clue!", True),
        ("🧠 Brilliant deduction!", True),
        ("😅 Wrong suspect!", False),
    ],
