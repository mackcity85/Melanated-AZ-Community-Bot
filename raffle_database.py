...
# If /var/data is not mounted, the bot stops instead of

# creating a temporary database that could be lost.

#

# Existing database data is never automatically deleted.
...
# The database MUST be located on the Render Persistent Disk.

#

# We intentionally refuse to use:
...
# because that filesystem is not persistent.
...
# ------------------------------------------------------
#
# Helps SQLite handle concurrent reads/writes more
# reliably.
# ------------------------------------------------------
