...
PERMANENT_TOPIC_IDS = {RAFFLE_TOPIC_ID, QOTD_TOPIC_ID, INTRO_TOPIC_ID, GAMES_TOPIC_ID, SOCIAL_MEDIA_TOPIC_ID, MEDIA_TOPIC_ID}
MESSAGE_STORE = Path(os.environ.get("CHAT_CLEANUP_STORE", "/var/data/bot_cleanup_messages.json"))
DAILY_MESSAGE_MARKERS = ("DAILY COMMUNITY", "GOOD MORNING", "GOOD AFTERNOON", "GOOD EVENING", "COMMUNITY CHECK-IN")
