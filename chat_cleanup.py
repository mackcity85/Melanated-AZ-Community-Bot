...
PERMANENT_TOPIC_IDS = {RAFFLE_TOPIC_ID, QOTD_TOPIC_ID, DAILY_MESSAGE_TOPIC_ID, INTRO_TOPIC_ID, GAMES_TOPIC_ID, SOCIAL_MEDIA_TOPIC_ID, MEDIA_TOPIC_ID, EVENT_TOPIC_ID}
